...
id: GNN-2
track: gnn
title: Heterogeneous Venue Ecosystem Graph
depends_on:
  - GNN-1
...
## OBJECTIVE
Implement Heterogeneous Venue Ecosystem Graph as a decision-complete command in the Graph Neural Networks track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_10_GRAPH_NEURAL_NETWORKS.md section GNN-2 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_10_GRAPH_NEURAL_NETWORKS.md section GNN-2`.
