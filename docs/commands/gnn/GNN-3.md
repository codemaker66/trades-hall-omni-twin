...
id: GNN-3
track: gnn
title: Recommendation System (LightGCN + PinSage)
depends_on:
  - GNN-2
...
## OBJECTIVE
Implement Recommendation System (LightGCN + PinSage) as a decision-complete command in the Graph Neural Networks track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_10_GRAPH_NEURAL_NETWORKS.md section GNN-3 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_10_GRAPH_NEURAL_NETWORKS.md section GNN-3`.
