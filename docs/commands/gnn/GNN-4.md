...
id: GNN-4
track: gnn
title: Spatial Layout Understanding
depends_on:
  - GNN-3
...
## OBJECTIVE
Implement Spatial Layout Understanding as a decision-complete command in the Graph Neural Networks track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_10_GRAPH_NEURAL_NETWORKS.md section GNN-4 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_10_GRAPH_NEURAL_NETWORKS.md section GNN-4`.
