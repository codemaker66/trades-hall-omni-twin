...
id: GNN-6
track: gnn
title: Temporal Graph Networks for Dynamic Booking
depends_on:
  - GNN-5
...
## OBJECTIVE
Implement Temporal Graph Networks for Dynamic Booking as a decision-complete command in the Graph Neural Networks track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_10_GRAPH_NEURAL_NETWORKS.md section GNN-6 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_10_GRAPH_NEURAL_NETWORKS.md section GNN-6`.
