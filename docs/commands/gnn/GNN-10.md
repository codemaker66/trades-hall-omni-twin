...
id: GNN-10
track: gnn
title: Explainability for Venue Recommendations
depends_on:
  - GNN-9
...
## OBJECTIVE
Implement Explainability for Venue Recommendations as a decision-complete command in the Graph Neural Networks track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_10_GRAPH_NEURAL_NETWORKS.md section GNN-10 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_10_GRAPH_NEURAL_NETWORKS.md section GNN-10`.
