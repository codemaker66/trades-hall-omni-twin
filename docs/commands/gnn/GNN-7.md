...
id: GNN-7
track: gnn
title: Graph Transformers (GPS Framework)
depends_on:
  - GNN-6
...
## OBJECTIVE
Implement Graph Transformers (GPS Framework) as a decision-complete command in the Graph Neural Networks track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_10_GRAPH_NEURAL_NETWORKS.md section GNN-7 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_10_GRAPH_NEURAL_NETWORKS.md section GNN-7`.
