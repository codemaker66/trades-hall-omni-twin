...
id: SLT-6
track: stat-learning
title: Tree Ensembles — The Correct Default for Venue Tabular Data
depends_on:
  - SLT-5
...
## OBJECTIVE
Implement Tree Ensembles — The Correct Default for Venue Tabular Data as a decision-complete command in the Statistical Learning track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_07_STATISTICAL_LEARNING_THEORY.md section SLT-6 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_07_STATISTICAL_LEARNING_THEORY.md section SLT-6`.
