...
title: Stochastic Demand Models (Poisson → Hawkes → Cox)
depends_on:
  - SP-5
...
## OBJECTIVE
Implement Stochastic Demand Models (Poisson → Hawkes → Cox) as a decision-complete command in the Stochastic Pricing track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_04_STOCHASTIC_PRICING.md section SP-6 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_04_STOCHASTIC_PRICING.md section SP-6`.
