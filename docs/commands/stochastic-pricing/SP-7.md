...
title: Monte Carlo Engine with Variance Reduction + QMC
depends_on:
  - SP-6
...
## OBJECTIVE
Implement Monte Carlo Engine with Variance Reduction + QMC as a decision-complete command in the Stochastic Pricing track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_04_STOCHASTIC_PRICING.md section SP-7 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_04_STOCHASTIC_PRICING.md section SP-7`.
