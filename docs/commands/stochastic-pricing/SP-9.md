...
title: Portfolio Theory — Booking Mix Optimization
depends_on:
  - SP-INT-2
...
## OBJECTIVE
Implement Portfolio Theory — Booking Mix Optimization as a decision-complete command in the Stochastic Pricing track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_04_STOCHASTIC_PRICING.md section SP-9 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_04_STOCHASTIC_PRICING.md section SP-9`.
