...
id: HPC-INT-1
track: hpc
title: HPC integration checkpoint 1
depends_on:
  - HPC-1
  - HPC-2
  - HPC-3
...
## OBJECTIVE
Integrate the completed command set for checkpoint 1 into one verified working flow.
...
- PREREQUISITES: `HPC-1`, `HPC-2`, `HPC-3`, `HPC-4`
