...
id: HPC-12
track: hpc
title: Numerical Linear Algebra Decision Matrix
depends_on:
  - HPC-11
source_technique: TECHNIQUE_06_HPC_PARALLEL_ARCHITECTURE.md
session_boundary_required: true
status: ready
---

## OBJECTIVE
Implement Numerical Linear Algebra Decision Matrix as a decision-complete command in the HPC track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_06_HPC_PARALLEL_ARCHITECTURE.md section HPC-12 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_06_HPC_PARALLEL_ARCHITECTURE.md section HPC-12`.
