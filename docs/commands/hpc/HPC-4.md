...
id: HPC-4
track: hpc
title: GPU Server Compute (JAX + RAPIDS + PyTorch)
depends_on:
  - HPC-3
...
## OBJECTIVE
Implement GPU Server Compute (JAX + RAPIDS + PyTorch) as a decision-complete command in the HPC track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_06_HPC_PARALLEL_ARCHITECTURE.md section HPC-4 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_06_HPC_PARALLEL_ARCHITECTURE.md section HPC-4`.
