...
id: HPC-3
track: hpc
title: Web Worker Pool with SharedArrayBuffer
depends_on:
  - HPC-2
...
## OBJECTIVE
Implement Web Worker Pool with SharedArrayBuffer as a decision-complete command in the HPC track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_06_HPC_PARALLEL_ARCHITECTURE.md section HPC-3 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_06_HPC_PARALLEL_ARCHITECTURE.md section HPC-3`.
