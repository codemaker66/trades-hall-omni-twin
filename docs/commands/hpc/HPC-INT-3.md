...
id: HPC-INT-3
track: hpc
title: HPC integration checkpoint 3
depends_on:
  - HPC-9
  - HPC-10
  - HPC-11
...
## OBJECTIVE
Integrate the completed command set for checkpoint 3 into one verified working flow.
...
- Source of truth: `TECHNIQUE_06_HPC_PARALLEL_ARCHITECTURE.md`.
...
- PREREQUISITES: `HPC-9`, `HPC-10`, `HPC-11`, `HPC-12`
