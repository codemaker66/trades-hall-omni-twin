...
title: Compressed Sensing for Sparse Venue Data
depends_on:
  - SIG-INT-2
...
## OBJECTIVE
Implement Compressed Sensing for Sparse Venue Data as a decision-complete command in the Signal Processing track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_08_SIGNAL_PROCESSING.md section SP-9 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_08_SIGNAL_PROCESSING.md section SP-9`.
