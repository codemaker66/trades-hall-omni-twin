...
title: Crowd Flow and Evacuation Control
depends_on:
  - OC-7
...
## OBJECTIVE
Implement Crowd Flow and Evacuation Control as a decision-complete command in the Optimal Control track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_09_OPTIMAL_CONTROL.md section OC-8 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_09_OPTIMAL_CONTROL.md section OC-8`.
