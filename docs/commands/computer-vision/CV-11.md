...
title: WebXR — AR Furniture Preview and VR Walkthroughs
depends_on:
  - CV-10
...
## OBJECTIVE
Implement WebXR — AR Furniture Preview and VR Walkthroughs as a decision-complete command in the Computer Vision track.

## CONTEXT
This command migrates authoritative implementation intent from TECHNIQUE_11_COMPUTER_VISION_3D_RECONSTRUCTION.md section CV-11 into the canonical execution format.

## TECHNICAL SPECIFICATION
- Source of truth: `TECHNIQUE_11_COMPUTER_VISION_3D_RECONSTRUCTION.md section CV-11`.
